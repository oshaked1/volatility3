    ...
    def get_task_info(cls,
        ...
        if credinfo:
            ...
            try:
                ...
                pass
            try:
                info.cap_inh = cred.cap_inheritable.get_capabilities()
            except exceptions.PagedInvalidAddressException:
                pass
            try:
                info.cap_prm = cred.cap_permitted.get_capabilities()
            except exceptions.PagedInvalidAddressException:
                pass
            try:
                info.cap_eff = cred.cap_effective.get_capabilities()
            except exceptions.PagedInvalidAddressException:
                pass
            try:
                info.cap_bnd = cred.cap_bset.get_capabilities()
            except exceptions.PagedInvalidAddressException:
                pass
