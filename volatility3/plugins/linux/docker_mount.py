...
class Mount(interfaces.plugins.PluginInterface):
    ...
    def get_mounts(cls,
        ...
        for task in docker_pslist.PsList.list_tasks(context=context, vmlinux_module_name=vmlinux_module_name, filter_func=pid_filter):
            ...
            # walk mount list
            for mount in mnt_ns.get_mount_points():
                yield task, mount
